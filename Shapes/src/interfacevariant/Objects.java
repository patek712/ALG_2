...
public class Objects {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<ShapeInterface> shapes3 = new ArrayList<>(); //dynamicke pole objektu, ktere implementuji ShapeInterface
        //muze obsahovat cokoliv, co je typove kompatibilni s ShapeInterface
        //nelze Shapeinterface s = new Rectangle(5,6);
        //ani Rectangle r = new ShapeInterface();
        shapes3.add(c1);
        shapes3.add(c2);
        shapes3.add(r1);
        double allArea3 = 0;
